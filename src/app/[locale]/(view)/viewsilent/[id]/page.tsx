  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="mt-16 mb-8 w-full md:w-3/4">
        <Button variant="outline" asChild>
          <Link href="/viewsilent">
            <span className="text-md">
              <FontAwesomeIcon icon={faArrowLeft} />&nbsp;{t("Silent.backToViewAll")}
            </span>
          </Link>
        </Button>
        <Card className="my-8">
        ...
        <ViewCards cardType="silent" id={parseInt(id, 10)} locale={locale} isReply />
        <ViewCardsReplyForm cardType="silent" cardId={parseInt(id, 10)} className="my-4" locale={locale} />
      </div>
    </div>
  );
}